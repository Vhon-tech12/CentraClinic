...
const services = [
  ...
  },
  {
    ...
    description:
      "Advanced aesthetic procedures to rejuvenate your skin, reduce signs of aging, and enhance your natural beauty with safe, effective techniques.",
    icon: faFaceSmile,
  },
  {
  ...
  },
  {
    ...
    description:
      "Replenish your body with essential vitamins and nutrients through customized IV drips, promoting wellness, energy, and overall vitality.",
    icon: faSyringe,
  },
  {
    title: "Tattoo Removal",
    description:
      "Safe and effective laser technology to remove unwanted tattoos, restoring your skin's natural appearance with minimal discomfort.",
    icon: faEraser,
  },
];
            ...
            >
              ...
              <p
                className={
                  ...
                  (service.active ? "text-indigo-100" : "text-gray-600")
                }
              >
                {service.description}
              </p>
